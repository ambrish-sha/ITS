<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="org_subject_creation.aspx.cs" Inherits="ITS.org_subject_creation" %>
...
<body style="background-color:lightblue;">
    ...
    <div>
      <div class="container" >
           <h1 class="style2"><strong>Create New Subject</strong></h1>
    ...
    <input type="text" class="form-control" id="subject" runat="server" placeholder="Enter Subject Name" value="" name="subject" required>
