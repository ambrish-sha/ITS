...
namespace ITS
{
    public partial class org_student_dashboard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (org != "")
                {
                    span_user.InnerText = "Welcome "+Session["stuid"].ToString();

                    myFrame.Attributes.Add("src", "/org_student_home.aspx");
                }
                else
                {
