<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="org_student_exam_list.aspx.cs" Inherits="ITS.org_student_exam_list" EnableEventValidation="false" %>
...
<body style="background-color:lightblue;">
    <form id="form1" runat="server">
        <div>
            ...
            <h4>Current/Upcoming Test </h4>
         
            <asp:Panel ID="Panel1" runat="server" Height="400px" BorderColor="Black" BorderStyle="Double" ScrollBars="Both">
               <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                    <ContentTemplate>--%>
                <asp:GridView ID="GridView1" BackColor="white" ShowFooter="true" DataKeyNames="ExamName,SubjectName,LinkOpenTime" AutoGenerateColumns="false" CssClass="table table-striped"  runat="server" PageSize="10" AutoGenerateSelectButton="false"   >
   ...
   <rowstyle height="10px" />
              ...
              <asp:TemplateField HeaderText="Total Marks">  
                    <ItemTemplate>  
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("TotalMarks") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
                 ...
                 <asp:TemplateField HeaderText="Exam Duration">  
                    <ItemTemplate>  
                        <asp:Label ID="totmarks" runat="server" Text='<%# Bind("ExamDuration") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>  
                    ...
                    <ItemTemplate>  
                      ...
                      <asp:TemplateField HeaderText="Link Open Time">  
                    <ItemTemplate>  
                        <asp:Label ID="startdate" runat="server" Text='<%# Bind("LinkOpenTime") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>

                 <asp:TemplateField HeaderText="Link Close Time">  
                    <ItemTemplate>  
                        <asp:Label ID="enddate" runat="server" Text='<%# Bind("LinkCloseTime") %>'></asp:Label>  
                    </ItemTemplate>  
                </asp:TemplateField>
                    ...
                    <ItemTemplate>  
                        <asp:Button ID="starttest" runat="server" CssClass="btn btn-warning" Text="Start Test" OnClick="starttest_Click" CommandArgument='<%# Eval("ExamName")+"~"+Eval("SubjectName")+"~"+Eval("LinkOpenTime") %>'/>
                    </ItemTemplate>  
                </asp:TemplateField>
